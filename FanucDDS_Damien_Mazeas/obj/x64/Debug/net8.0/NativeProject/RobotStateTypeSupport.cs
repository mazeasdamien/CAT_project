...
// DDS version: 3.31.0
// ACE version: 7.1.3
// Running on input file: C:\Users\Damien Mazeas\Desktop\CAT\FanucDDS_Damien_Mazeas/IDL\RobotState.idl
// </autogenerated>
...
namespace RobotDDS
{
	...
	public class RobotStateTypeSupport : ITypeSupport<RobotState>
    {
        ...
        //private static readonly RobotStateSerializerContext _serializerContext = new RobotStateSerializerContext(_serializerOptions);
        ...
        {
            // Issue with keywords identifiers "@". Avoid code generator serialization
            //return JsonSerializer.Serialize(sample, typeof(RobotState), _serializerContext);
            return JsonSerializer.Serialize(sample, typeof(RobotState));
        }

        public RobotState DecodeFromString(string str)
        {
            // Issue with keywords identifiers "@". Avoid code generator serialization
            //return JsonSerializer.Deserialize(str, typeof(RobotState), _serializerContext) as RobotState;
            return JsonSerializer.Deserialize(str, typeof(RobotState)) as RobotState;
        }
